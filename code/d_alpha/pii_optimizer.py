...
def get_optimizer(cfg, model, print_fn=None):
    ...
    head_layer_names = ["classification_head"]  # List of head layer names
    ...
    for name, param in model.named_parameters():
        ...
        # Check if parameter belongs to any head layer
    ...
    # Example - optimizer_class is torch.optim.Adam: 
