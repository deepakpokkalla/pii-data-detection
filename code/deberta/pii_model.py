...
class DebertaForPII(DebertaV2PreTrainedModel):
    def __init__(self, config):
        ...
        self.classification_head = nn.Linear(config.hidden_size, config.num_labels, bias=False) # (hs:768)
    ...
    def forward(
        ...
        **kwargs,
        ...
        logits = self.classification_head(sequence_output) # (batch_size, seq_len, num_labels)
